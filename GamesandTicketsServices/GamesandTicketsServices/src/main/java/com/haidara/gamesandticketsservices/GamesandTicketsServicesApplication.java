package com.haidara.gamesandticketsservices;
...
import com.haidara.gamesandticketsservices.exceptions.custome.GameIdNotFoundException;
...
import com.haidara.gamesandticketsservices.exceptions.custome.TicketsSoldOutException;
...
@AllArgsConstructor
public class GamesandTicketsServicesApplication {
    GameServices gameServices;
    TicketServices ticketServices;

    public static void main(String[] args) {
        SpringApplication.run(GamesandTicketsServicesApplication.class, args);
    }
